...
- **ความยากที่พบ (Difficulty):** สีขนของหมีขั้วโลกกับสีหิมะมันขาวเหมือนกันจนแทบแยกไม่ออก
![D4](output/D4.png)
...
- **ความยากที่พบ (Difficulty):** กิ้งก่ามีลวดลายพรางตัวที่กลืนไปกับพื้นหลังเป็นอย่างมาก ท้าทายเทคนิค Color หรือ Edge-Based ทั่วไป
![D5](output/D5.png)
...
- **ความยากที่พบ (Difficulty):** วัตถุถูกบดบังบางส่วนและมีรูปแบบการบดบังที่ไม่เป็นระเบียบของกิ่งไม้
![D8](output/D8.png)

#### D9 – ทิวทัศน์หมอกหนา — ตรวจจับต้นไม้
- **เครดิตที่มาของภาพ (Source):** [คลิกเพื่อดูภาพจากแหล่งที่มา](https://pin.it/5Zv5rxRCh)
- **วัตถุเป้าหมายที่ต้องการตรวจจับ:** ทิวทัศน์หมอกหนา — ตรวจจับต้นไม้
- **เทคนิคและพารามิเตอร์ที่ใช้:** Normalization(clipLimit=4.0) + GaussianBlur(5×5) + Canny(15,50) + Dark Region Masking
- **ความยากที่พบ (Difficulty):** Contrast ต่ำรุนแรงจากหมอกทำให้เส้นขอบเขตไม่มีความชัดเจน
![D9](output/D9.png)

#### D10 – แมวดำบนโซฟาสีเทา
- **เครดิตที่มาของภาพ (Source):** [คลิกเพื่อดูภาพจากแหล่งที่มา](https://pin.it/7Kg6lwfTk)
- **วัตถุเป้าหมายที่ต้องการตรวจจับ:** แมวดำบนโซฟาสีเทา
...
- **ความยากที่พบ (Difficulty):** แมวและโซฟามีสี ความสว่าง และ Texture คล้ายกันจนแทบแยกไม่ออก ต้องใช้ Multi-Orientation Filter ตรวจจับลักษณะขนแมวที่มีทิศทาง
![D10](output/D10.png)
...
- **สาเหตุที่ไม่สำเร็จ:** (ตามที่คาดไว้) เป็นเพราะเสื้อทหารลายพรางถูกออกแบบมาเพื่อพรางตัว ทำให้การตรวจจับสีและเท็กซ์เจอร์ไม่สามารถทำได้
- **ความคิดเห็น (เทคนิคความสามารถพิเศษที่จำเป็น):** จำเป็นต้องใช้ความสามารถของ AI ด้าน Semantic Understanding เช่น โมเดล Deep Learning ที่สามารถเข้าใจรูปทรงของมนุษย์และเสื้อผ้า
![FE1](output/FE1.png)
...
- **สาเหตุที่ไม่สำเร็จ:** (ตามที่คาดไว้) ลวดลายขนนกฮูกมีความคล้ายกับเปลือกไม้ ทำให้แยกความแตกต่างในระดับ Pixel ออกจากกันแทบไม่ได้
...
- **สาเหตุที่ไม่สำเร็จ:** (ตามที่คาดไว้) สีของปลาแต่ละตัวคล้ายกับสีของปะการังหรือดอกไม้ทะเล อาศัยการแยกสีไม่ได้ผลเพราะไม่มีสีที่แยกชัดเพื่อบ่งชี้ว่าเป็นปลา
...
- **สาเหตุที่ไม่สำเร็จ:** (ตามที่คาดไว้) แมลงกิ่งไม้มีลักษณะทางชีวภาพ Texture พรางตัวเหมือนเปลือกไม้แทบทุกประการ
...
- **สาเหตุที่ไม่สำเร็จ:** (ตามที่คาดไว้) ร่มสีแดงมีสีแดงคล้ายกับมะเขือเทศ ระบบสกัดเฉพาะสีจึงแยก "ผลไม้" หรือ "วัตถุ" ออกจากกันไม่ได้เลย
...
- **ความคิดเห็น (เทคนิคความสามารถพิเศษที่จำเป็น):** ต้องใช้ Deep Learning โดยเป็นโมเดลที่ถูกฝึกให้รู้จัก 'อวัยวะ' แต่ละส่วนมาแล้วอย่างแม่นยำ ซึงจะไม่ได้ดูแค่ว่าสีอะไร แต่มันจะมองหาว่า 'ตรงไหนคือช่วงลำตัว ตรงไหนคือแขน และตรงไหนคือแนวเสื้อผ้า'
![FE6](output/FE6.png)
...
- **ความคิดเห็น (เทคนิคความสามารถพิเศษที่จำเป็น):** ใช้เครื่องมือพิเศษอย่าง 'กล้องตรวจจับความร้อน' (Thermal Sensor) ที่มองเห็นรังสีความร้อนจากเครื่องยนต์หรือตัวรถได้แม้มืดสนิท
![FE7](output/FE7.png)
...
- **ความคิดเห็น (เทคนิคความสามารถพิเศษที่จำเป็น):** ใช้เทคนิคการวิเคราะห์ความลึก (Depth Sensing) หรือการใช้โมเดล Deep Learning ที่ถูกฝึกให้รู้จัก 'รูปร่างปลา' โดยเฉพาะ
![FE9](output/FE9.png)
...
- **ความคิดเห็น (เทคนิคความสามารถพิเศษที่จำเป็น):** จำเป็นต้องใช้ความสามารถด้าน Semantic Understanding ข้อมูลขนาดใหญ่จาก Deep Learning (CNN, Transformers) ที่จะเข้าใจว่ารูปทรงบริเวณที่มีเงาสว่างขนาดนี้คือ "แก้ว"
![FU3](output/FU3.png)
...
- **สาเหตุที่ไม่สำเร็จ:** แก้วโปร่งแสงดูดซับสีพื้นหลัง ไม่มี Consistent Color Region ส่วน Canny และ Otsu ก็ตรวจจับเพียงพื้นหลังแทน
...
| **FU4** | ขวดแก้วใส | Canny + Otsu + LAB b-channel | ล้มเหลว (แก้วโปร่งแสงดูดซับสีพื้นหลัง) |
